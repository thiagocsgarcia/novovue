            ...
            <form v-on:submit="saveForm()">
                <div class="row">
                    <div class="col-xs-12 col-md-4 form-group">
                        ...
                        <the-mask id="cnpj" :mask="['###.###.###-##', '##.###.###/####-##']" :masked="true" v-model="empresa.cnpj" class="form-control" placeholder="99.999.999/9999-99"></the-mask>
                    </div>
                    <div class="col-xs-12 col-md-4 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-4 form-group">
                        ...
                        <the-mask id="cep" mask="#####-###" :masked="true" v-model="empresa.cep" class="form-control" placeholder="99999-999"></the-mask>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-md-4 form-group">
                        <label for="telefone" class="control-label">Telefone</label>
                        <the-mask id="telefone" :mask="['(##) ####-####', '(##) #####-####']" :masked="true" v-model="empresa.telefone" class="form-control" placeholder="(99) 9999-9999"></the-mask>
                    </div>
                    <div class="col-xs-12 col-md-4 form-group">
                        <label for="telefone2" class="control-label">Telefone 2</label>
                        <the-mask id="telefone2" :mask="['(##) ####-####', '(##) #####-####']" :masked="true" v-model="empresa.telefone2" class="form-control" placeholder="(99) 9999-9999"></the-mask>
                    </div>
                    <div class="col-xs-12 col-md-4 form-group">
                        <label for="celular" class="control-label">Celular</label>
                        <the-mask id="celular" :mask="['(##) ####-####', '(##) #####-####']" :masked="true" v-model="empresa.celular" class="form-control" placeholder="(99) 99999-9999"></the-mask>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-md-12 form-group">
