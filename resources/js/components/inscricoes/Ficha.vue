<template>
  <div class="py-5 px-3" style="background-color:#FFFFFF">
    ...
    <form action="#" method="post">
      ...
      <h5 class="pt-5">CURSO</h5>

      <div class="form-group col-md-12">
        <label for="curso_interesse">Curso de Interesse</label>
        <input
          readonly
          type="text"
